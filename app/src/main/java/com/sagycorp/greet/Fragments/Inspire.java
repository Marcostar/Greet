    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Email.putExtra(Intent.EXTRA_TEXT,"***Do not copy stories from internet.*** Do not forget to tell your NAME and your COUNTRY (So We can put your name along with your story.)");
